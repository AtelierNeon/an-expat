...
####
PROJECT_EXPAT_WITH_DISABLED_APPS="${MY_PROJECT_EXPAT_WITH_DISABLED_APPS:=OFF}"
PROJECT_EXPAT_WITH_DISABLED_TEST_APPS="${MY_PROJECT_EXPAT_WITH_DISABLED_TEST_APPS:=OFF}"
...
if [ "ON" = "$PROJECT_EXPAT_WITH_DISABLED_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DEXPAT_WITH_DISABLED_APPS=$PROJECT_EXPAT_WITH_DISABLED_APPS")
fi
if [ "ON" = "$PROJECT_EXPAT_WITH_DISABLED_TEST_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DEXPAT_WITH_DISABLED_TEST_APPS=$PROJECT_EXPAT_WITH_DISABLED_TEST_APPS")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: expat with disabled apps: $PROJECT_EXPAT_WITH_DISABLED_APPS"
echo "[$SYSTEM_PLATFORM] Component information: expat with disabled test apps: $PROJECT_EXPAT_WITH_DISABLED_TEST_APPS"
